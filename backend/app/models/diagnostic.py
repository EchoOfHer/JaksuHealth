...
class Diagnostic(Base):
    ...
    visit_id = Column(UUID(as_uuid=True), ForeignKey("visits.visit_id", ondelete="CASCADE"), unique=True, nullable=False)
    risk_level = Column(String(20), nullable=False) # HIGH RISK, MED, LOW
    condition_stage = Column(String(50), nullable=False) # Intermediate AMD, Early AMD, Normal, Other
    ...
    visit = relationship("Visit", back_populates="diagnostic")
